...
public class MD5 {
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File("d:" + File.separator + "app-release-unaligned_241_1.1.5(1).apk");
		String md5 = getFileMD5String(file);
//
//		// 文件名不同，内容相同；
//		File file2 = new File("d:" + File.separator + "1234.txt");
//		String md52 = getFileMD5String(file2);
//
//		// 文件名不同，内容不同；
//		File file3 = new File("d:" + File.separator + "12345.txt");
//		String md53 = getFileMD5String(file3);
//
//		// 测试压缩包
//		File fileZip = new File("d:" + File.separator + "1234.zip");
//		String md5Zip = getFileMD5String(fileZip);
//		// 测试压缩包
//		File fileZip2 = new File("d:" + File.separator + "12345.zip");
...
//		System.out.println("测试压缩包,内容不同" + checkPassword(md5Zip, md5Zip2));
		...
		System.out.println("md51:" + md5 + " time:" + ((end - begin) / 1000)
				+ "s");
//		System.out.println("md52:" + md52 + " time:" + ((end - begin) / 1000)
//				+ "s");
//		System.out.println("md53:" + md53 + " time:" + ((end - begin) / 1000)
//				+ "s");
